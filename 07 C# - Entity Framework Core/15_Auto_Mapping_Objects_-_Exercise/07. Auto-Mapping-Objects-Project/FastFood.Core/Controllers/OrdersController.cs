...
namespace FastFood.Core.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                Items = this.context.Items.ProjectTo<CreateOrderItemViewModel>(this.mapper.ConfigurationProvider)
                    .ToList(),
                Employees = this.context.Employees.ProjectTo<CreateOrderEmployeeViewModel>(this.mapper.ConfigurationProvider)
                    .ToList()
            };
